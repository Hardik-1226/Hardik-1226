...
### 🛡️ [SheSecure](https://github.com/Hardik-1226) — Women Safety Software
> AI-powered safety system with **voice alerts, real-time SOS**, and hotspot mapping
> - Emergency contact notifications & live hazard mapping

### 🌊 [VarunSetu](https://github.com/Hardik-1226) — SIH Internal Round Shortlist
> Real-time disaster response app built with **React Native (Expo)**
...
**Freelance Web Developer** · Health Plus Innovation Pvt. Ltd. *(Jan 2026 – Present)*
- Rebuilt pharmaceutical e-commerce platform from legacy PHP → **React.js**
- Integrated Razorpay payment gateway · Deployed at [hpi.co.in](https://hpi.co.in)

**PR Lead** · Abhyudaya Club, GL Bajaj *(July 2025 – Present)*
- Organized **Supernova Hackathon** with 500+ participants & multiple sponsorships
- Grew social media engagement by **50%+** through strategic outreach
